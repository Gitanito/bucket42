...
So wird jedes Getränk in einer hässlichen Tasse serviert. 
Dafür ist der Eintopf wirklich gut und regeneriert euch wie 8 Stunden Pause.
Einen Schlafplatz gibt es auch - aber nur EINEN.


| Angebot  | Wirkung | Preis  |
| -------- | ------ | --- |
| Schlafen | 8 Std Schlaf | 1 Gold |
| Essen    | 8 Std Schlaf | 1 Gold |
| Trinken  | 2 Std Schlaf | 5 Silber|
