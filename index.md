...
This is why i write my own plots and translate some plots from all over the world into the german language.
...
- [Charakterbögen](https://dnd.wizards.com/de/resources/character-sheets)


### Plot / DM-Stuff
- [Welche D&D 5e Rasse passt am besten zu dir? - Quickphix TTRPG](https://quickphix.ch/de/werkzeugkiste/dnd-rassen-quiz/)
...
- [DriveThruRPG.com - The Largest RPG Download Store!](https://www.drivethrurpg.com/index.php)
- [D&D Compendium - Plot Hooks](https://www.dnd-compendium.com/dm-resources/plot-hooks)
- [Monsters 5e » Dungeons & Dragons - DnD 5e](https://www.aidedd.org/dnd-filters/monsters.php)
- [Plots for DMs](http://www.dndadventure.com/html/articles/plots.html)
- [50 Adventure Hooks To Steal For Your Game : DnD](https://www.reddit.com/r/DnD/comments/9adid0/50_adventure_hooks_to_steal_for_your_game/)
- [D3: D&D 5e Schnellreferenz](https://www.dnddeutsch.de/schnellreferenz/)
- [cheatsheet – D3: Dungeons & Dragons auf Deutsch](https://www.dnddeutsch.de/tag/cheatsheet/)
...
<script src="https://cdn.jsdelivr.net/npm/mermaid/dist/mermaid.min.js"></script> <script> mermaid.initialize({ startOnLoad: true }); </script> Here is one mermaid diagram: <div class="mermaid"> graph TD A[Client] --> B[Load Balancer] B --> C[Server1] B --> D[Server2] </div> And here is another: <div class="mermaid"> graph TD A[Client] -->|tcp_123| B B(Load Balancer) B -->|tcp_456| C[Server1] B -->|tcp_456| D[Server2] </div>
